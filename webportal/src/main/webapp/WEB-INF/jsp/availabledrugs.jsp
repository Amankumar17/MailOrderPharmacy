...
<body>
    ...
    <nav class="navbar navbar-inverse ">
        <a href="home" class="navbar-brand" ><img width="60px" height="60px" src="images/lo.png">Mail Order Pharmacy</a>
 ...
 Services
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <br><br><br><br><br>
    <h1 class="center " style="color: #F08080;"><b>INVENTORY</b></h1>
	<br><br>
	<section id="services">
        <div class="container" >
            <div class="row">
                    ...
                    <div class="col-4">
                        <div class="flip-card-inner" >
                            <div class="">
                                ...
                                <h1 style="color:#ff9900"><b>${itr.drugName}</b></h1><br>
                                ...
                                <h3>Expiry Date: ${itr.expiryDate}</h3><br>
                                    ...
                                    <h1  style="color:#0000FF"><b>Availability</b></h1><br>
                                    <marquee width="60%" direction="down" height="100px"  Scrollamount=2 onMouseOver="this.stop()" onMouseOut="this.start()" >
